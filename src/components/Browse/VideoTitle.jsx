      ...
      <div className="flex h-full w-full max-w-xl flex-col justify-center px-4 pt-14 sm:px-8 sm:pt-16 md:max-w-2xl md:px-12">
        ...
        <div className="mt-5 flex flex-wrap gap-3 sm:mt-0 sm:gap-4">
            <Link
              ...
              className="flex items-center cursor-pointer gap-1 rounded bg-white px-5 py-2.5 text-base font-semibold text-black transition hover:bg-white/80 focus:outline-none focus:ring-2 focus:ring-white sm:px-8 sm:text-lg"
            >
             <IoIosPlay />
             <span>Play</span>
            </Link>
            <Link
              to={`/browse/movie/${movieId}`}
              className="hidden cursor-pointer items-center gap-1 rounded bg-gray-500/70 px-5 py-2.5 text-base font-semibold text-white transition hover:bg-gray-500 sm:flex sm:px-8 sm:text-lg"
            >
              <MdOutlineInfo/>
